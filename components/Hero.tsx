export function Hero() {
  return (
    <section className="relative mx-auto h-[650px] w-full max-w-[760px] overflow-hidden rounded-2xl bg-black md:h-[550px]">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-end gap-4 px-6 pb-12 text-center">
        ...
        <p className="max-w-[280px] font-display text-sm text-gray-200 md:max-w-lg md:text-base">
