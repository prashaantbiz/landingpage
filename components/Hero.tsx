export function Hero() {
  return (
    <section className="relative mx-auto h-[560px] w-full max-w-[760px] overflow-hidden rounded-2xl bg-black md:h-[550px]">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-end gap-2 px-6 pb-6 text-center md:gap-4 md:pb-12">
        ...
        <p className="className="max-w-[240px] font-display text-xs text-gray-200 md:max-w-lg md:text-base"">
